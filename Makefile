...
OBJS = $(OBJS_CONTROL) $(OBJS_GNL) $(OBJS_LST) $(OBJS_MATHFUNS) $(OBJS_MEMSFUNS) $(OBJS_PUTFUNS) $(OBJS_STR) $(OBJS_TESTING) $(OBJS_PRINTF) $(OBJS_TIMER)
SRCS = $(SRCS_CONTROL) $(SRCS_GNL) $(SRCS_LST) $(SRCS_MATHFUNS) $(SRCS_MEMSFUNS) $(SRCS_PUTFUNS) $(SRCS_STR) $(SRCS_TESTING) $(SRCS_PRINTF) $(SRCS_TIMER)
